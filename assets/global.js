...
class HeaderDrawer extends MenuDrawer {
  constructor() {
    super();
    this.closeBtn = this.querySelectorAll('.header__icon--close');
    this.closeBtn.forEach((closeBtn) => {
      closeBtn.addEventListener('click', () => {
        this.querySelector('.header__icon--summary').click()
      });
    })
  }
    ...
    const handleIntersection = (entries, observer) => {
      ...
      fetch(this.dataset.url)
        ...
        .then((text) => {
          ...
          let elem = document.querySelector('.related-products__slider');
          ...
          let flkty = new Flickity( elem, defaultOptions);
        })
        .catch((e) => {
          console.error(e);
        });
